...
const args = {
	jdNotify: false,
	pageSize: 12,
	cidsList: ["家用电器", "手机数码", "电脑办公", "家居家装","美妆护肤","服饰鞋包", "母婴玩具", "生鲜美食", "图书音像","钟表奢品", "食品饮料", "更多惊喜"],
	typeList: ["普通试用", "闪电试用"],
	whiteList: ["网易##春风##避孕套","情趣内衣","杰士邦##零感##避孕套","情趣扑克牌","高跟鞋##35","高跟鞋##36","文胸##75##A","文胸##74##A","文胸##73##A","胸罩##75##A","胸罩##74##A","胸罩##73##A"],
