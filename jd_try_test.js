...
const args = {
	jdNotify: false,
	pageSize: 12,
	cidsList: ["家用电器", "手机数码", "电脑办公", "家居家装","美妆护肤", "母婴玩具", "生鲜美食", "图书音像","钟表奢品", "食品饮料", "更多惊喜"],
	typeList: ["普通试用", "闪电试用"],
	whiteList: ["情趣内衣","显示屏","华为手环","打印机","贵州茅台","青岛啤酒","燕京啤酒","精酿","茅台王子酒","键盘","雅诗兰黛","兰蔻","雅培","爱他美","卓萃","飞鹤","美赞臣","贝因美","HFP","露得清","维多利亚的秘密","五粮液","国窖1573","蓝牙耳机","矿泉水","元気森林","九阳豆浆机","玉米油","羽毛球拍","大米","面粉","燕麦","乌苏","泸州老窖","汾酒","沱牌","郎酒","雀巢","钟薛高","平板电视机","星巴克","施华洛世奇","香薰蜡烛"],
	goodFilters: "教程@流量@软件@英语@辅导@培训小靓美@脚气@文胸@卷尺@种子@档案袋@癣@中年@老太太@妇女@私处@孕妇@卫生巾@卫生条@课@培训@阴道@生殖器@肛门@狐臭@少女内衣@胸罩@洋娃娃@男孩玩具@女孩玩具@益智@少女@女性内衣@女性内裤@女内裤@女内衣@女孩@鱼饵@钓鱼@童装@吊带@黑丝@钢圈@婴儿@儿童@玩具@幼儿@娃娃@网课@网校@电商@手机壳@钢化膜@车载充电器@网络课程@女纯棉@三角裤@美少女@纸尿裤@英语@俄语@四级@六级@四六级@在线网络@在线@阴道炎@宫颈@糜烂@打底裤@手机膜@鱼@狗@看房游@手机卡@油烟机@病人@自慰@手机膜@手机壳@中老年".split('@'),
	minPrice: 1000,
	maxSupplyCount: 100,
...
async function filterGoodList() {
	...
	const now = Date.now()
	const oneMoreDay = now + 24 * 60 * 60 * 1000 * 1
