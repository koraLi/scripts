...
const args = {
	...
	whiteList: ["显示屏","华为手环","联名","青岛啤酒","燕京啤酒","精酿","茅台王子酒","键盘","雅诗兰黛","兰蔻","雅培","爱他美","卓萃","飞鹤","美赞臣","贝因美",
		   ...
		   "晾衣架","烧水壶","摄像机##DV","999##银","洗衣机","空气净化器","自行车","装饰品","装饰画","正版授权","食用油","摆件","羊脂白玉","和田白玉","男##面霜","剃须刀","燃力士",
		   "苏泊尔","烧烤架","九阳","投影仪","起泡##酒","香薰机","冰糯种##翡翠","冰种##翡翠","北欧##沙发","墙纸","雪花秀套装滋盈肌本七夕限定礼盒","除螨仪","求婚##表白##道具",
		   "范思哲##VERSACE","榴莲##斤"],
