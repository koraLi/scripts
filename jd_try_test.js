...
const args = {
	jdNotify: false,
	pageSize: 12,
	cidsList: ["家用电器", "手机数码", "电脑办公", "家居家装","美妆护肤", "母婴玩具", "生鲜美食", "钟表奢品", "食品饮料", "更多惊喜"],
	typeList: ["普通试用", "闪电试用"],
	whiteList: ["显示屏","华为手环","打印机","贵州茅台","青岛啤酒","燕京啤酒","精酿","茅台王子酒","键盘","雅诗兰黛","兰蔻","雅培","爱他美","卓萃","飞鹤","美赞臣","贝因美","HFP","露得清","维多利亚的秘密","五粮液","国窖1573","蓝牙耳机","矿泉水","元気森林","九阳豆浆机","玉米油","羽毛球拍","大米","面粉","燕麦","乌苏##啤酒","泸州老窖","汾酒","沱牌","郎酒","雀巢","钟薛高","平板电视机","星巴克","施华洛世奇","香薰蜡烛","中粮","技嘉##主板","京东Plus会员","茅台生态","酒鬼","牛栏山","红星二锅头","牛奶##g","牛奶##ml","牛奶##L","洋河蓝色经典","金龙鱼","张裕##葡萄酒","拉菲##葡萄酒","三只松鼠##大礼包","叶帆##摇摇椅","电竞椅","全身镜","屏幕挂灯","运动鞋##男##41##黑","制冰机","冰淇淋机","唱吧K歌宝","科大讯飞##录音笔","无人机","移动硬盘","固态硬盘","SK-II","风扇","茅台##葡萄酒","红花郎","青花郎","茶叶","茶##g","德芙","长城##葡萄酒","衡水老白干","百草味##大礼包","白葡萄酒","香槟##葡萄酒","威士忌","小龙虾","肉卷","三文鱼","火锅##食材##套餐","鹿肉","和牛##牛排","烤肉##套餐","玩具枪","坦克##玩具","婴儿车","滑板车","剧情杀","海贼王手办","华为##P30pro##手机膜","华为##P30PRO##手机膜","军工##望远镜","口罩##n94","口罩##N94","口罩##n95","口罩##N95","小米##MI","读书郎##学习##桌椅","鲍鱼##礼盒","无线充电","桂林漓泉老炮","元气森林"],
	goodFilters: "教程@流量@软件@英语@辅导@培训小靓美@脚气@文胸@卷尺@种子@档案袋@癣@中年@老太太@妇女@私处@孕妇@卫生巾@卫生条@课@培训@阴道@生殖器@肛门@狐臭@少女内衣@胸罩@少女@女性内衣@女性内裤@女内裤@女内衣@女孩@鱼饵@钓鱼@童装@吊带@黑丝@钢圈@网课@网校@电商@手机壳@钢化膜@车载充电器@网络课程@女纯棉@三角裤@美少女@纸尿裤@英语@俄语@四级@六级@四六级@在线网络@在线@阴道炎@宫颈@糜烂@打底裤@鱼@狗@看房游@手机卡@油烟机@病人@自慰@中老年@情趣内衣@张艺兴同框".split('@'),
	minPrice: 1000,
	maxSupplyCount: 100,
	white_price_limit: 50,
	limit_day: 1
}
