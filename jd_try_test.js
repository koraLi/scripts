...
const args = {
	...
	whiteList: ["显示屏","华为手环","联名","青岛啤酒","燕京啤酒","精酿","茅台王子酒","键盘","雅诗兰黛","兰蔻","雅培","爱他美","卓萃","飞鹤","美赞臣","贝因美",
		   ...
		   "翊玄玩具","levi##李维斯","拾月礼##结婚","海飞丝##洗发水","挖耳勺","洗衣液","DDR4","手套##保暖","棉拖鞋","围脖","雷蛇","茶##包","自热米饭","啤酒##听","啤酒##罐",
		   "轻奢##北欧##椅","牙膏","玻尿酸##食用","智能垃圾桶","头皮按摩","头部按摩","俯卧撑##健身##智能","手电筒","厨具##菜刀","厨房##菜刀","抽纸","纸抽","玻尿酸##洗面奶",
		   "螨虫##洗面奶","新鲜##黄桃##斤","绵阳米粉","筋膜枪","无线鼠标","升降桌","解酒","红外体温计","体温枪","京昱达##北欧##桌","润泽霜","玻尿酸##糖","伯西亚##睡衣","秋裤##男",
		   "KW##煤油##打火机","易持健##健身器材"],
	goodFilters: "教程@软件@培训小靓美@脚气@卷尺@种子@档案袋@癣@老太太@妇女@孕妇@卫生巾@卫生条@课@培训@阴道@生殖器@肛门@狐臭@少女内衣@胸罩@女性内衣@女性内裤@女内裤@女内衣@女孩@鱼饵@钓鱼@童装@吊带@黑丝@网课@网校@电商@手机壳@钢化膜@车载充电器@网络课程@女纯棉@三角裤@美少女@纸尿裤@俄语@四级@六级@四六级@在线网络@在线@阴道炎@宫颈@糜烂@打底裤@看房游@手机卡@病人@自慰@中老年@情趣内衣@张艺兴同框".split('@'),
	minPrice: 799,
	maxSupplyCount: 300,
